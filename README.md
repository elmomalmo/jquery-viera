jQuery - VIERA Edition
=======================

*WORK IN PROGRESS*

This is a small subset of the jQuery library intended for use on a Panasonic VIERA Connect TV, where there is no browser API.
...
To build your own version of the jquery-viera version, run `make jquery-viera` or `make jquery-viera-min`.
